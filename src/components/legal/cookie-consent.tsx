          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Link href="/privacy" locale={locale}>
                <Button 
                  variant="ghost"
                  className="w-full text-slate-400 font-bold h-10 text-[10px] uppercase tracking-widest rounded-xl hover:text-blue-600 transition-all"
                >
                  {locale === 'en' ? 'Learn More' : 'Les mer'}
                </Button>
              </Link>
            </div>
          </div>
